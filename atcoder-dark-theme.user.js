// ==UserScript==
// @name         AtCoder Theme: Refined Dark
// @namespace    http://atcoder.jp/
// @version      0.2.3
// @description  Refined dark theme for AtCoder
...
(function () {
  ...
  document.head.insertAdjacentHTML(
    ...
    String.raw`
          <style>
        /* https://cdn.jsdelivr.net/npm/bootstrap-solarized@1.0.2/bootstrap-solarized-dark.css */
    ...
    color:${base04};
        ...
        *:after {
        ...
        .nav-tabs > li > a:hover {
          border-color: ${base00} ${base00} ${base01};
        }
